...
def get_unit_test_names() -> dict[str, dict[str, list[str]]]:
    files = [
        x
...
def check_differences_between_rules_and_tests(force: bool = False):
    unit_tests = get_unit_test_names()
...
if __name__ == "__main__":
    rules = check_differences_between_rules_and_tests(force=True)
