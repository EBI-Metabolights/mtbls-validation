...
| 27 | rule_i_100_320_003_01 | WARNING | DOI invalid for published study publication. | A study publication with status published should have valid DOI. |
| 28 | rule_i_100_320_003_02 | WARNING | DOI format invalid for study publication. | If DOI is defined, its format should be a valid. |
| 29 | rule_i_100_320_004_01 | WARNING | PubMed ID invalid for published study publication. | A study publication with status published should have valid PubMed ID. Valid PubMed ID contains only digits. |
| 30 | rule_i_100_320_004_02 | WARNING | PubMed ID format invalid for study publication. | If PubMed ID is defined, its format should be valid PubMed ID. Valid PubMed ID contains only digits. |
| 31 | rule_i_100_320_005_01 | ERROR | Study Publication Title length less than 25 characters. | Study Publication Title must be defined with length equal or greater than 25 characters. |
| 32 | rule_i_100_320_006_01 | ERROR | Study Publication Author List is empty. | Study Publication Author List must be defined. |
| 33 | rule_i_100_320_007_01 | ERROR | Study Publication Status is empty. | Study Publication Status must be defined. |
...
| 67 | rule_i_100_350_003_03 | ERROR | Study Protocol Description contains only template message. | Study Protocol Description should be updated. Do not use template message. |
