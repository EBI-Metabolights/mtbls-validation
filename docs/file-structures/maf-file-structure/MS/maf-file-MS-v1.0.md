...
Download file template as [zip file](../../../template-files/maf-file/MS/m_template-MS-v1.0_metabolite_profiling_v2_maf.tsv.zip) or [tsv file](../../../template-files/maf-file/MS/m_template-MS-v1.0_metabolite_profiling_v2_maf.tsv)
...
| retention_time | single column |  | All 'retention_time' column values must be defined in metabolite assignment file for LC-MS / GC-MS. |  |
| taxid | single column |  |  |  |
