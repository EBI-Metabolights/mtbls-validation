# NMR Assay File Default Structure v1.0

Download file template as [zip file](../../../template-files/assay-file/NMR/a_template-NMR-metabolite_profiling-v1.0.txt.zip) or [txt file](../../../template-files/assay-file/NMR/a_template-NMR-metabolite_profiling-v1.0.txt)

| Header  | Column Structure  | Constraints | <div style="width: 300px">Description</div> | <div style="width: 100px">Examples</div> |
|--------|-------------------|----------|-------------|----------
| Sample Name | single column | *Required*<br/>MinLength: 1<br/><br/>[Controls](../../../prioritised-control-lists/assay-file-control-lists/NMR/NMR-v1.0.md#sample-name){:target="_blank"} | A unique identifier from a particular source (a batch of samples can have a unique Sample name as identified in the Sample table). It’s usually associated with an output spectral data filename. | pas101220_104 |
...
| Parameter Value[Extraction Method] | single column |  | This how a sample was extracted from its source material. | Methanol |
...
| Parameter Value[Sample pH] | single column | *Required*<br/>MinLength: 1 | Sample pH value. | 7 |
...
| Parameter Value[Number of transients] | single column | *Required*<br/>MinLength: 1 | The number of scans acquired. This information can be found in the ‘Acquisition Parameter Data File’, ‘acqus.txt’ found within the Bruker raw data file structure, in the field marked ‘$NS=’. | 128 |
| Parameter Value[Pulse sequence name] | single column | *Required*<br/>MinLength: 1 | The pulse sequence program used with a short description.This information can be found in the ‘Acquisition Parameter Data File’, ‘acqus.txt’ found within the Bruker raw data file structure, in the field marked ‘ $PULPROG= ’ and in the file ‘pulseprogram.txt’. | 1D 1H with presaturation (presat) |
| Parameter Value[Magnetic field strength] | single column and unit ontology | *Required*<br/>MinLength: 1 | Unit will be defined in the next column. | 11.7 numeric value with tesla unit |
...
| NMR Assay Name | single column | [Controls](../../../prioritised-control-lists/assay-file-control-lists/NMR/NMR-v1.0.md#nmr-assay-name){:target="_blank"} | This can be, but doesn’t have to be, the same as the ‘Sample Name’. | 17_QC1 |
