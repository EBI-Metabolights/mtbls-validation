...
Download file template as [zip file](../../../template-files/assay-file/LC-DAD/a_template-LC-DAD-metabolite_profiling-v2.0.txt.zip) or [txt file](../../../template-files/assay-file/LC-DAD/a_template-LC-DAD-metabolite_profiling-v2.0.txt)

| Header  | Column Structure  | Constraints | <div style="width: 300px">Description</div> | <div style="width: 100px">Examples</div> |
|--------|-------------------|----------|-------------|----------
| Sample Name | single column | *Required*<br/>MinLength: 1<br/><br/>[Controls](../../../prioritised-control-lists/assay-file-control-lists/LC-DAD/LC-DAD-v2.0.md#sample-name){:target="_blank"} |  |  |
...
| Parameter Value[Signal range] | single column and unit ontology |  |  |  |
| Parameter Value[Resolution] | single column and unit ontology |  |  |  |
