# MRImaging Assay File Default Structure v2.0

Download file template as [zip file](../../../template-files/assay-file/MRImaging/a_template-MRImaging-metabolite_profiling-v2.0.txt.zip) or [txt file](../../../template-files/assay-file/MRImaging/a_template-MRImaging-metabolite_profiling-v2.0.txt)

| Header  | Column Structure  | Constraints | <div style="width: 300px">Description</div> | <div style="width: 100px">Examples</div> |
|--------|-------------------|----------|-------------|----------
| Sample Name | single column | [Controls](../../../prioritised-control-lists/assay-file-control-lists/MRImaging/MRImaging-v2.0.md#sample-name){:target="_blank"} |  |  |
...
| Parameter Value[Number of transients] | single column and unit ontology |  |  |  |
...
| NMR Assay Name | single column | [Controls](../../../prioritised-control-lists/assay-file-control-lists/MRImaging/MRImaging-v2.0.md#nmr-assay-name){:target="_blank"} |  |  |
