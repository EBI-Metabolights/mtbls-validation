...
rule_a_100_100_001_05_test_cases := 1
...
test_rule_a_100_100_001_05_no_violation_01 if {
	result := rules.rule_a_100_100_001_05 with input as {
		...
		with data.metabolights.validation.v2.rules.phase1.definitions.__ASSAY_PROTOCOL_HEADER_COLUMNS as {
			"a_MTBLS1.txt": [
				1,
				5,
				17,
		...
		with data.metabolights.validation.v2.rules.phase1.definitions.__ASSAY_DEFAULT_PROTOCOL_HEADERS as {
			"a_MTBLS1.txt": [
				"Extraction",
				"Chromatography",
				"Mass spectrometry",
