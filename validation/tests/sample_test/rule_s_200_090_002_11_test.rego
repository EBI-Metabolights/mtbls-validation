...
rule_s_200_090_002_11_test_cases := 1

# METADATA
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_11_no_violation_01 if {
	...
	result := rules.rule_s_200_090_002_11 with input as input_data
		with data.metabolights.validation.v2.controls.sampleFileControls as {"__default_factor_value__": [selected_rule]}
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_11_no_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_11_no_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_11_no_violation_04 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_11_violation_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_11_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_11_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_11_violation_04 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
