#########################################################################################################
# Unit tests for rule_s_200_090_007_03
#########################################################################################################
...
rule_s_200_090_007_03_test_cases := 1

# METADATA
# title: <title>.
# description: <description>.
test_rule_s_200_090_007_03_no_violation_01 if {
	...
	result := rules.rule_s_200_090_007_03 with input as input_data
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_007_03_violation_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
