...
rule_s_200_090_002_10_test_cases := 1
...
test_rule_s_200_090_002_10_no_violation_01 if {
	...
	result := rules.rule_s_200_090_002_10 with input as input_data
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_10_no_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_10_no_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_10_no_violation_04 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_10_violation_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_10_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_10_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: <title>.
# description: <description>.
test_rule_s_200_090_002_10_violation_04 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
