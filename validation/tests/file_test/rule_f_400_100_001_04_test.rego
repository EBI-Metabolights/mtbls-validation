#########################################################################################################
# Unit tests for rule_f_400_100_001_04
#########################################################################################################
...
rule_f_400_100_001_04_test_cases := 1
	...
	input_data := json.patch(
		...
		[
			...
			},
			{
				...
				"value": {"x.raw": {"extension": ".raw"}},
			},
		],
	)

	result := rules.rule_f_400_100_001_04 with input as input_data
