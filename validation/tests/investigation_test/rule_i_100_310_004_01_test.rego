#########################################################################################################
# Unit tests for rule_i_100_310_004_01
#########################################################################################################
...
rule_i_100_310_004_01_test_cases := 1
...
test_rule_i_100_310_004_01_no_violation_01 if {
	...
	result := rules.rule_i_100_310_004_01 with input as input_data
...
test_rule_i_100_310_004_01_no_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
test_rule_i_100_310_004_01_no_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
# title: Study Design Type term is not in the ontology list
# description: RULE_STUDY_DESIGN_TYPE empty dict
test_rule_i_100_310_004_01_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
# title: Study Design Type term is not in the ontology list
# description:  RULE_STUDY_DESIGN_TYPE  is 'check-only-constraints' type
test_rule_i_100_310_004_01_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
