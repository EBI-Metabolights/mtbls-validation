#########################################################################################################
# Unit tests for rule_i_100_320_007_13
#########################################################################################################
...
rule_i_100_320_007_13_test_cases := 1
...
test_rule_i_100_320_007_13_no_violation_01 if {
...
test_rule_i_100_320_007_13_no_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_13_no_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_13_violation_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: Study Publication Status term is not in the ontology list
# description: RULE_PUBLICATION_STATUS empty dict
test_rule_i_100_320_007_13_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: Study Publication Status term is not in the ontology list
# description:  RULE_PUBLICATION_STATUS  is 'check-only-constraints' type
test_rule_i_100_320_007_13_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
