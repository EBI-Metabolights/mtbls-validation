#########################################################################################################
# Unit tests for rule_i_100_320_007_14
#########################################################################################################
...
test_rule_i_100_320_007_14_no_violation_01 if {
	...
	result := rules.rule_i_100_320_007_14 with input as input_data
	count(result) == 0
}
...
test_rule_i_100_320_007_14_violation_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
