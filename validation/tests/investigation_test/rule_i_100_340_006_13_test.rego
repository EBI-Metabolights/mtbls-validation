#########################################################################################################
# Unit tests for rule_i_100_340_006_13
#########################################################################################################
...
test_rule_i_100_340_006_13_no_violation_01 if {
	...
	result := rules.rule_i_100_340_006_13 with input as input_data
		with def.RULE_ASSAY_TECHNOLOGY_TYPE as {}
...
test_rule_i_100_340_006_13_no_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
test_rule_i_100_340_006_13_no_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
test_rule_i_100_340_006_13_no_violation_04 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
test_rule_i_100_340_006_13_violation_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
test_rule_i_100_340_006_13_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
test_rule_i_100_340_006_13_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
...
test_rule_i_100_340_006_13_violation_04 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[{
