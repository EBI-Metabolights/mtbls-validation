#########################################################################################################
# Unit tests for rule_i_100_330_003_13
#########################################################################################################
...
test_rule_i_100_330_003_13_no_violation_01 if {
...
test_rule_i_100_330_003_13_no_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_330_003_13_no_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_330_003_13_violation_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: Study Factor Type term is not in the ontology list
# description: RULE_STUDY_FACTOR_TYPE empty dict
test_rule_i_100_330_003_13_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: Study Factor Type term is not in the ontology list
# description:  RULE_STUDY_FACTOR_TYPE  is 'check-only-constraints' type
test_rule_i_100_330_003_13_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
