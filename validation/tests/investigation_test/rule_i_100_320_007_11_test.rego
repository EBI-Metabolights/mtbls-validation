#########################################################################################################
# Unit tests for rule_i_100_320_007_11
#########################################################################################################
...
rule_i_100_320_007_11_test_cases := 1
...
test_rule_i_100_320_007_11_no_violation_01 if {
...
test_rule_i_100_320_007_11_no_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_no_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_no_violation_04 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_no_violation_selected_ontologies_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_violation_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_violation_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_violation_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_violation_04 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_violation_05 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_violation_06 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_violation_selected_ontologies_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: Study Publication Status term source ref is  empty
# description: Study Publication Status term  source ref is empty
test_rule_i_100_320_007_11_violation_selected_ontologies_02 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
# title: Study Publication Status term has invalid placeholder value
# description: Study Publication Status term has invalid placeholder value
test_rule_i_100_320_007_11_violation_selected_ontologies_03 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
...
test_rule_i_100_320_007_11_violation_child_ontology_01 if {
	input_01 := data.tests.data.inputs.minimum_01
	input_data := json.patch(
		input_01,
		[
